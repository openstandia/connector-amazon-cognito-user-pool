...
public class CognitoUserPoolFilter {
    ...
    public CognitoUserPoolFilter(String attributeName, FilterType filterType, String attributeValue) {
        this.attributeName = attributeName;
        this.filterType = filterType;
        this.attributeValue = attributeValue;
    }

    public CognitoUserPoolFilter(String attributeName, FilterType filterType) {
        this.attributeName = attributeName;
        this.filterType = filterType;
